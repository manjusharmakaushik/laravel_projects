    ...
    <div class="col-12 col-lg-12">
        ...
        <div class="card mb-6">
            <div class="card-header">
                <h5 class="card-title mb-0">Add Service Sector Information</h5>
            </div>
            <div class="card-body">
                <form id="serviceForm" enctype="multipart/form-data" action="{{ route('sector-store') }}" method="POST">
                    @csrf
                    <div class="row gx-5 mb-5">
                        <div class="col">
                            <div class="form-floating form-floating-outline">
                                <input type="text" class="form-control" id="name" placeholder="Enter Service Sector Name"
                                    name="name" aria-label="Full Name">
                                <label for="name">Service Sector Name</label>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-floating form-floating-outline">
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        Swal.fire({
                            icon: 'success',
                            title: 'Success',
                            text: 'Service Sector added successfully!'
                        }).then(function() {
