...
@section('content')
    ...
    <section class="section">
        <div class="card">
            <div class="card-body">
                <h3>Service Sector Information</h3>
                <div class="row g-3 mt-3">
                    <div class="col-md-4">
                        <label class="form-label" style="font-weight: bold;">Name</label>
                        <p class="form-control-plaintext">{{ $viewService->sector_name }}</p>
                    </div>
                    <!-- <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                         <label class="form-label" style="font-weight: bold;">Sector Image</label> 
                    ...
                    <div class="col-12">
                        <a href="{{ route('sector-list') }}" class="btn btn-primary">Back to List</a>
